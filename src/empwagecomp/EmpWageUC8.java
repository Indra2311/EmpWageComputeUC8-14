...
public class EmpWageUC8 {
    ...
    EmpWageUC8(String companyName, int wagePerHr, int maxWorkingDays, int maxWorkingHrs)
    {
    ...
    {
    	EmpWageUC8 LT = new EmpWageUC8("L&T", 8, 20, 100);
    	EmpWageUC8 Walmart = new EmpWageUC8("Walmart", 4, 30, 150);
